...
//AND lodger.fname LIKE '%$keyword%'
//OR official.lodger_ssn = reservation.lodger_ssn ORDER BY lodger.lname";
$query = "SELECT lodger.ssn, lodger.lname, lodger.fname, lodger.mname,official.room_code, official.appliancerate, official.monthlybal, official.appliancerate + official.monthlybal AS total FROM lodger, official WHERE lodger.ssn = official.lodger_ssn AND lodger.fname LIKE '%$keyword%' ORDER BY lodger.lname ASC ";
