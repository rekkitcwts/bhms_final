...
$query = "SELECT lodger.ssn, lodger.lname, lodger.fname, lodger.mname, reservation.roomcode, reservation.resdate, reservation.resdeadline FROM lodger, reservation WHERE lodger.ssn = reservation.lodger_ssn AND lodger.lname LIKE '%$keyword%' ORDER BY lodger.lname ASC";
